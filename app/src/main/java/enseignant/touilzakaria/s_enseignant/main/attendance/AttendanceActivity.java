package enseignant.touilzakaria.s_enseignant.main.attendance;
...
import enseignant.touilzakaria.s_enseignant.main.components.ListAdapter;
...
public class AttendanceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        period = getIntent().getStringExtra("PÉRIODE");

        Log.d("Présence", time + " -- " + period);
        ...
        btnx.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getBaseContext(), "Sauvegarde ...", Toast.LENGTH_LONG).show();
                adapter.saveAll();
            }
        });
