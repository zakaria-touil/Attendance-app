    ...
    public View getView(final int position, View v, ViewGroup parent) {
        ...
        textView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(final View v) {
                ...
                alert.setTitle("Modifier la présence de l'etudiant");
                alert.setMessage("Êtes-vous sûr?");
                alert.setPositiveButton("Présent", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (AppBase.handler.execAction(qu)) {
                            Toast.makeText(activity, "Terminé", Toast.LENGTH_LONG).show();
                        }
                        Log.d("profile", qu);
                    }
                });
