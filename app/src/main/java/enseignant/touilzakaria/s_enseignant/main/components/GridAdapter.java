package enseignant.touilzakaria.s_enseignant.main.components;
...
import enseignant.touilzakaria.s_enseignant.main.attendance.AttendanceActivity;
import enseignant.touilzakaria.s_enseignant.main.notes.NoteActivity;
import enseignant.touilzakaria.s_enseignant.main.profile.ProfileActivity;
import enseignant.touilzakaria.s_enseignant.main.schedule.Scheduler;
...
//        notificationIntent.putExtra(MainListAdapter.IS_EMERGENCY, true);
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(activity.getBaseContext())
                .setTicker("Titre").setContentTitle("Des notes sont disponibles pour ce sujet")
    ...
    public View getView(int position, View v, ViewGroup parent) {
        ...
        } else if (names.get(position).toString().equals("REMARQUES")) {
